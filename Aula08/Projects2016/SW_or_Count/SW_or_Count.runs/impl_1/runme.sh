...
HD_PWD='K:/MostFrequentlyNeeded___2014/Education2011/2015_2016/SecondSemester/CR/AulasTeoricas/Aula8_11april2016/Projects2016/SW_or_Count/SW_or_Count.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_counter_display_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source BD_counter_display_wrapper.tcl -notrace
