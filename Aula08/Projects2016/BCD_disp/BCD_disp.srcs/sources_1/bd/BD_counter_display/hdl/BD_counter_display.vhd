...
entity BD_counter_display is
  ...
  attribute CORE_GENERATION_INFO of BD_counter_display : entity is "BD_counter_display,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=BD_counter_display,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=5,numReposBlks=5,numNonXlnxBlks=2,numHierBlks=0,maxHierDepth=0,synth_mode=Global}";
