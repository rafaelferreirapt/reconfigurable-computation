...
set rc [catch {
  ...
  set_property webtalk.parent_dir /media/psf/Home/Development/ect_ua/reconfigurable-computation/rom_unroll_nao_funfa/rom_unroll_nao_funfa.cache/wt [current_project]
  set_property parent.project_path /media/psf/Home/Development/ect_ua/reconfigurable-computation/rom_unroll_nao_funfa/rom_unroll_nao_funfa.xpr [current_project]
  set_property ip_repo_paths {
  /media/psf/Home/Development/ect_ua/reconfigurable-computation/rom_unroll_nao_funfa/rom_unroll_nao_funfa.cache/ip
  /media/psf/Home/Development/ect_ua/reconfigurable-computation/Aula08/Projects2016/UserDefinedRepository
} [current_project]
  set_property ip_output_repo /media/psf/Home/Development/ect_ua/reconfigurable-computation/rom_unroll_nao_funfa/rom_unroll_nao_funfa.cache/ip [current_project]
  add_files -quiet /media/psf/Home/Development/ect_ua/reconfigurable-computation/rom_unroll_nao_funfa/rom_unroll_nao_funfa.runs/synth_1/ex4_wrapper.dcp
  read_xdc /media/psf/Home/Development/ect_ua/reconfigurable-computation/rom_unroll_nao_funfa/rom_unroll_nao_funfa.srcs/constrs_1/imports/xdc/Nexys4_Master.xdc
