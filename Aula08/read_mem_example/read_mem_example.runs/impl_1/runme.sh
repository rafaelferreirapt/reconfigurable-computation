...
HD_PWD='/media/psf/Home/Development/ect_ua/reconfigurable-computation/rom_unroll_nao_funfa/rom_unroll_nao_funfa.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ex4_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source ex4_wrapper.tcl -notrace
