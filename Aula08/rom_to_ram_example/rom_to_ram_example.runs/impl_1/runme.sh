...
HD_PWD='/media/psf/Home/Development/ect_ua/reconfigurable-computation/Aula08/rom_ram_hamming/rom_ram_hamming.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log example_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source example_wrapper.tcl -notrace
