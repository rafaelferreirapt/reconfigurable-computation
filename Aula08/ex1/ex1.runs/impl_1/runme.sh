...
HD_PWD='Y:/Development/ect_ua/reconfigurable-computation/Aula08/ex1/ex1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ex1_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source ex1_wrapper.tcl -notrace
