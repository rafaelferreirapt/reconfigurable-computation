...
HD_PWD='Y:/Development/ect_ua/reconfigurable-computation/Aula05/exercicio54/exercicio54.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Ex54_aula5.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Ex54_aula5.tcl -notrace
