...
HD_PWD='Z:/Desktop/StudyWorkTeam/4ano/2Semestre/CR/Aula05/ex54/ex54.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Ex54.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Ex54.tcl -notrace
