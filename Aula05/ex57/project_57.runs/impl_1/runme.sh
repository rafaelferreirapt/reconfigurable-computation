...
HD_PWD='X:/Universidade/4Ano/2Semestre/CR/Arquivo/project_57/project_57.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ex57.vdi -applog -m64 -messageDb vivado.pb -mode batch -source ex57.tcl -notrace
