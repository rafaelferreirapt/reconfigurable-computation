...
set rc [catch {
  ...
  set_property webtalk.parent_dir {Y:/Development/ect_ua/reconfigurable-computation/Aula 04/ex1/ex1.cache/wt} [current_project]
  set_property parent.project_path {Y:/Development/ect_ua/reconfigurable-computation/Aula 04/ex1/ex1.xpr} [current_project]
  set_property ip_repo_paths {{y:/Development/ect_ua/reconfigurable-computation/Aula 04/ex1/ex1.cache/ip}} [current_project]
  set_property ip_output_repo {{y:/Development/ect_ua/reconfigurable-computation/Aula 04/ex1/ex1.cache/ip}} [current_project]
  add_files -quiet {{Y:/Development/ect_ua/reconfigurable-computation/Aula 04/ex1/ex1.runs/synth_1/ex1.dcp}}
  read_xdc {{Y:/Development/ect_ua/reconfigurable-computation/Aula 04/ex1/ex1.srcs/constrs_1/imports/Rodrigo/Nexys4_Master.xdc}}
