...
HD_PWD='Z:/Desktop/StudyWorkTeam/4ano/2Semestre/CR/Aula05/ex58/ex58.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log use_Iterative_Sorter_FSM.vdi -applog -m64 -messageDb vivado.pb -mode batch -source use_Iterative_Sorter_FSM.tcl -notrace
