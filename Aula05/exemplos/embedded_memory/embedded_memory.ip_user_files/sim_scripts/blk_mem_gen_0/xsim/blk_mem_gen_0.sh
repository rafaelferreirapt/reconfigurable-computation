...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto c683e13a234c4df3b18211ba2eb1827a -m64 -L blk_mem_gen_v8_3_1 -L work -L secureip --snapshot blk_mem_gen_0 work.blk_mem_gen_0 -log elaborate.log
}
