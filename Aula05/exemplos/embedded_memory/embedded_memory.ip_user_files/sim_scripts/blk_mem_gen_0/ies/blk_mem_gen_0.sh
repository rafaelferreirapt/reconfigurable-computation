...
#
# Generated by Vivado on Tue Mar 15 14:36:31 +0000 2016
...
compile()
{
  ...
  ncvhdl -work work $opts_vhd \
    "$ref_dir/../../../ip/blk_mem_gen_0/sim/blk_mem_gen_0.vhd" \
...
elaborate()
{
  ...
  libs="-libname secureip -libname blk_mem_gen_v8_3_1 -libname work"
  ncelab $opts work.blk_mem_gen_0 $libs
}
...
simulate()
{
  ...
  ncsim $opts work.blk_mem_gen_0 -input simulate.do
}
# Script usage
usage()
{
