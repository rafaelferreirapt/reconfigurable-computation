...
HD_PWD='X:/Partilhado 4A2S/CR/Praticas - Jerónimo/aula5_2/ex510/ex510.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Ex59.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Ex59.tcl -notrace
