...
HD_PWD='Y:/Development/ect_ua/reconfigurable-computation/Aula05/ex51/ex51.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log exercise.vdi -applog -m64 -messageDb vivado.pb -mode batch -source exercise.tcl -notrace
