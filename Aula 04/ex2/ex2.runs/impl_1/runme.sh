...
HD_PWD='Y:/Development/ect_ua/reconfigurable-computation/Aula 04/ex2/ex2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ex2.vdi -applog -m64 -messageDb vivado.pb -mode batch -source ex2.tcl -notrace
