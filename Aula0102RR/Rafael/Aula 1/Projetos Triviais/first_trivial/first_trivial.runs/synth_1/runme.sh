...
HD_PWD='Z:/Desktop/StudyWorkTeam/4ano/2Semestre/CR/Rodrigo/Projetos Triviais/first_trivial/first_trivial.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my.vds -m64 -mode batch -messageDb vivado.pb -notrace -source my.tcl
