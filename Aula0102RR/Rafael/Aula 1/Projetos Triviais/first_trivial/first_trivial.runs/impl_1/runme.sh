...
HD_PWD='Z:/Desktop/StudyWorkTeam/4ano/2Semestre/CR/Rodrigo/Projetos Triviais/first_trivial/first_trivial.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my.vdi -applog -m64 -messageDb vivado.pb -mode batch -source my.tcl -notrace
