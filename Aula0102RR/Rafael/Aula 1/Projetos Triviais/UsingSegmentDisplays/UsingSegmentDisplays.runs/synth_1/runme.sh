...
HD_PWD='E:/MostFrequentlyNeeded___2014/Education2011/2014_2015/SecondSemester/CR/AllProjectsThat were_Used_for_CR_in_2014_2015/SDR_P/1/UsingSegmentDisplays/UsingSegmentDisplays.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopTrivial.vds -m64 -mode batch -messageDb vivado.pb -notrace -source TopTrivial.tcl
