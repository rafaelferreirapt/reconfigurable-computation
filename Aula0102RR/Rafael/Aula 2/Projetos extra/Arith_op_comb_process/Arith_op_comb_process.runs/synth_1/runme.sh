...
HD_PWD='K:/MostFrequentlyNeeded___2014/Education2011/2015_2016/SecondSemester/CR/AulasTeoricas/Aula2_22Feb2016/ToElearningProjects/Arith_op_comb_process/Arith_op_comb_process.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arith_op.vds -m64 -mode batch -messageDb vivado.pb -notrace -source arith_op.tcl
