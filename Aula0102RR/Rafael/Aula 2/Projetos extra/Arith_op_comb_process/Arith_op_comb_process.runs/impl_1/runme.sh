...
HD_PWD='K:/MostFrequentlyNeeded___2014/Education2011/2015_2016/SecondSemester/CR/AulasTeoricas/Aula2_22Feb2016/ToElearningProjects/Arith_op_comb_process/Arith_op_comb_process.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arith_op.vdi -applog -m64 -messageDb vivado.pb -mode batch -source arith_op.tcl -notrace
