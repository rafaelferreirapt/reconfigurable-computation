...
begin		
   ...
   reset <= '0';        	--sw <= "10101011";
   wait for 100 ns;	-- change signals as it is indicated above and wait for 100 ns
   reset <= '0';        	--sw <= "11111111";
   wait for 100 ns;	-- change signals as it is indicated above and wait for 100 ns
   reset <= '0';        	--sw <= "00000000";
   wait for 100 ns;	-- change signals as it is indicated above and wait for 100 ns
   reset <= '0';        	--sw <= "00100010";
   wait for 500 ns;	-- change signals as it is indicated above and wait for 500 ns
