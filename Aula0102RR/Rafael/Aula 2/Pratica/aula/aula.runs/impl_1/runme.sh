...
HD_PWD='Y:/Development/ect_ua/reconfigurable-computation/Rafael/Aula 2/Pratica/aula/aula.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ex22.vdi -applog -m64 -messageDb vivado.pb -mode batch -source ex22.tcl -notrace
