...
HD_PWD='K:/MostFrequentlyNeeded___2014/Education2011/2015_2016/SecondSemester/CR/AulasTeoricas/Aula7_4April2016/Exemplos2016/ROM_multiplier/ROM_multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Multiplier_ROM.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Multiplier_ROM.tcl -notrace
