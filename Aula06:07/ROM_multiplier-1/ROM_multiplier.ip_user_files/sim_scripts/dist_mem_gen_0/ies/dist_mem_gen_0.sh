...
#
# Generated by Vivado on Sun Apr 03 19:21:16 +0100 2016
...
compile()
{
  ...
  ncvhdl -work work $opts_vhd \
    "$ref_dir/../../../ip/dist_mem_gen_0/sim/dist_mem_gen_0.vhd" \
...
elaborate()
{
  ...
  libs="-libname secureip -libname dist_mem_gen_v8_0_9 -libname work"
  ncelab $opts work.dist_mem_gen_0 $libs
}
...
simulate()
{
  ...
  ncsim $opts work.dist_mem_gen_0 -input simulate.do
}
# Script usage
usage()
{
