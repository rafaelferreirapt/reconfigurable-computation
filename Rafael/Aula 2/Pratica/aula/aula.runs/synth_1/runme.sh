...
HD_PWD='Y:/Development/ect_ua/reconfigurable-computation/Rafael/Aula 2/Pratica/aula/aula.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ex22.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ex22.tcl
