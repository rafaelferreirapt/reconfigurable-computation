...
set_property PACKAGE_PIN T8 [get_ports {My_count[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {My_count[0]}]
#Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
set_property PACKAGE_PIN V9 [get_ports {My_count[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {My_count[1]}]
#Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = My_count2
set_property PACKAGE_PIN R8 [get_ports {My_count[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {My_count[2]}]
#Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = My_count3
set_property PACKAGE_PIN T6 [get_ports {My_count[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {My_count[3]}]
#Bank = 34, Pin name = IO_L12P_T1_MRCC_34,					Sch name = My_count4
#set_property PACKAGE_PIN T5 [get_ports {My_count[4]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {My_count[4]}]
...
#set_property MARK_DEBUG false [get_nets {My_count_OBUF[0]}]
#set_property MARK_DEBUG false [get_nets {My_count_OBUF[1]}]
#set_property MARK_DEBUG false [get_nets {My_count_OBUF[2]}]
#set_property MARK_DEBUG false [get_nets {My_count_OBUF[3]}]
set_property MARK_DEBUG true [get_nets {plusOp[0]}]
set_property MARK_DEBUG true [get_nets {plusOp[1]}]
set_property MARK_DEBUG true [get_nets {plusOp[2]}]
set_property MARK_DEBUG true [get_nets {plusOp[3]}]
