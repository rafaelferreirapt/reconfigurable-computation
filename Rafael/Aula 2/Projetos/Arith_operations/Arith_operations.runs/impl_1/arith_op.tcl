...
set rc [catch {
  ...
  set_property ip_repo_paths i:/SDR_P/1/Arith_operations/Arith_operations.cache/ip [current_project]
  set_property ip_output_repo i:/SDR_P/1/Arith_operations/Arith_operations.cache/ip [current_project]
  add_files -quiet I:/SDR_P/1/Arith_operations/Arith_operations.runs/synth_1/arith_op.dcp
...
set rc [catch {
  ...
  if { [file exists I:/SDR_P/1/Arith_operations/Arith_operations.runs/synth_1/arith_op.hwdef] } {
    catch { write_sysdef -hwdef I:/SDR_P/1/Arith_operations/Arith_operations.runs/synth_1/arith_op.hwdef -bitfile arith_op.bit -meminfo arith_op.mmi -file arith_op.sysdef }
  }
