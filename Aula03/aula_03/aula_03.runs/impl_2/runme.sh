...
HD_PWD='Y:/Development/ect_ua/reconfigurable-computation/Aula03/aula_03/aula_03.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log ex3.vdi -applog -m64 -messageDb vivado.pb -mode batch -source ex3.tcl -notrace
