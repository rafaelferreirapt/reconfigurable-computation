...
HD_PWD='X:/Universidade/4Ano/2Semestre/CR/reconfigurable-computation.git/Aula03/aula_03/aula_03.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ex4.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ex4.tcl
